...
class customRibbonBar(RibbonBar):
    ...
    def _set_category_home(self):
        ...
        new_button = file_panel.addSmallButton("New",QIcon("./icon/bootstrap/file-earmark-plus.svg"),alignment=Qt.AlignmentFlag.AlignLeft)
        open_button = file_panel.addSmallButton("Open",QIcon("./icon/bootstrap/folder2-open.svg"),alignment=Qt.AlignmentFlag.AlignLeft)
        export_button = file_panel.addSmallButton("Export",QIcon("./icon/bootstrap/box-arrow-right.svg"),alignment=Qt.AlignmentFlag.AlignLeft)
        save_button = file_panel.addSmallButton("Save",QIcon("./icon/bootstrap/save.svg"),alignment=Qt.AlignmentFlag.AlignLeft)
        save_as_button = file_panel.addSmallButton("Save As",QIcon("./icon/bootstrap/save-fill.svg"),alignment=Qt.AlignmentFlag.AlignLeft)
        report_button = file_panel.addSmallButton("Report",QIcon("./icon/bootstrap/archive.svg"),alignment=Qt.AlignmentFlag.AlignLeft)
